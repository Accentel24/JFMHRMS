                ...
                <div class="main-content-inner">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="hidden-480"><a href="editemp.php?id=<?php echo $t1['empid']; ?>"><img src="images/edit.png"></a>&nbsp;&nbsp;
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="hidden-480"><a href="editemp.php?id=<?php echo $rs1['empid']; ?>"><img src="images/edit.png"></a>&nbsp;&nbsp;
                            ...
                            <div align="center">
                                <?php
                                $sql = "SELECT COUNT(empid) AS total FROM " . $datatable ." where state = '$state'";
